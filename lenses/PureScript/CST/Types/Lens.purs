...
_SourcePos :: Iso' SourcePos
  { line :: Int
  , column :: Int
  }
_SourcePos = identity

_SourceRange :: Iso' SourceRange
  { start :: SourcePos
  , end :: SourcePos
  }
...
_Delimited :: forall a. Iso' (Delimited a) (Wrapped (Maybe (Separated a)))
_Delimited = identity

_DelimitedNonEmpty :: forall a. Iso' (DelimitedNonEmpty a) (Wrapped (Separated a))
...
_FixityFields :: Iso' FixityFields
