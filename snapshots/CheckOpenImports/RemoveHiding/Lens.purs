module Snapshots.CheckOpenImports.RemoveHiding.Lens where
...
import Snapshots.CheckOpenImports.RemoveHiding (Foo(..), One(..), Two(..))
...
_Foo :: Lens' Foo { arg1 :: One, arg2 :: Two, arg3 :: NameIsFine }
